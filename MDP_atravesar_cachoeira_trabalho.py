...
### Experimentos
def executarExperimentos(mdpObject,ambiente,nro_exp):
    ganma =  1
    epsilon = 0.00001
    for i in range(0,nro_exp):
        print('*********************************************')
        print('  Experimento '+ str(i) + ' em ' + ambiente)
...
executarExperimentos(mdpObject = mdp, ambiente = 'Ambiente1', nro_exp = 3)

mdp = MDP(So=1, G=2000, X=20, Y=100, ambiente='Ambiente2')
executarExperimentos(mdpObject = mdp, ambiente = 'Ambiente2', nro_exp = 3)

mdp = MDP(So=1, G=12500, X=50, Y=250, ambiente='Ambiente3')
executarExperimentos(mdpObject = mdp, ambiente = 'Ambiente3', nro_exp = 3)
